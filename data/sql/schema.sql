...
CREATE TABLE proposta (id BIGSERIAL, projeto_id BIGINT NOT NULL, status SMALLINT, comentarios TEXT, data_submissao DATE, data_feedback_orientador DATE, data_feedback_comissao DATE, documento VARCHAR(255), PRIMARY KEY(id));
