...
CREATE TABLE projeto (id BIGSERIAL, titulo VARCHAR(255) NOT NULL, estudante_id BIGINT NOT NULL, professor_id BIGINT NOT NULL, coorientadores VARCHAR(255), PRIMARY KEY(id));
...
CREATE TABLE semestre (id BIGSERIAL, nome VARCHAR(30), data_colacao DATE, data_colacao_especial DATE, data_max_proposta DATE, data_max_copiao DATE, data_max_defesa DATE, PRIMARY KEY(id));
