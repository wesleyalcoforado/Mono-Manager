...
orientando, <strong><?php echo $nomeEstudante; ?></strong>,  acabou de requisitar
a defesa do projeto <em><?php echo $tituloProjeto; ?></em>.</p>

<p><?php echo link_to('Clique aqui', 'defesa/list', array('absolute' => true)) ?> 
